...
public void Final()
       ...
       float DVA = (0*(B.y* ((C.z*1) - (1*DD.z)) -( B.z*( (C.y * 1) - (1*DD.y) )) + (1*((C.y*DD.z) - (DD.y*C.z)) ))
        ...
        if (DV0 < 0)
        {
            ...
            {
                print("point of origin is inside the boundury of 0 and A");
            }

            if (DVA > 0 && DVB < 0 && DVC > 0 && DVD > 0)
            {
                print("point of origin is inside the boundury of 0 and B");
            }
            if (DVA > 0 && DVB > 0 && DVC < 0 && DVD > 0)
            {
                print("point of origin is inside the boundury of 0 and C");
            }
            if (DVA > 0 && DVB > 0 && DVC > 0 && DVD < 0)
            {
                print("point of origin is inside the boundury of 0 and D");
            }
            ...
            if (DVA < 0 && DVB < 0 && DVC > 0 && DVD > 0)
            {
                print("point of origin is inside the boundury of 0, A, and B");
            }
            if (DVA < 0 && DVB > 0 && DVC < 0 && DVD > 0)
            {
                print("point of origin is inside the boundury of 0, A and C");
            }

            if (DVA < 0 && DVB > 0 && DVC > 0 && DVD < 0)
            {
                print("point of origin is inside the boundury of 0, A,D");
            }

            if (DVA > 0 && DVB < 0 && DVC > 0 && DVD < 0)
            {
                print("point of origin is inside the boundury of 0, B,D");
            }
            if (DVA > 0 && DVB < 0 && DVC < 0 && DVD > 0)
            {
                print("point of origin is inside the boundury of 0, B,C");
            }
            if (DVA > 0 && DVB > 0 && DVC < 0 && DVD < 0)
            {
                print("point of origin is inside the boundury of 0, C,D");
            }
            ...
            if (DVA < 0 && DVB < 0 && DVC < 0 && DVD > 0)
            {
                print("point of origin is inside the boundury of 0, A, B, C");
            }
            if (DVA < 0 && DVB < 0 && DVC > 0 && DVD < 0)
            {
                print("point of origin is inside the boundury of 0, A, B, D");
            }
            if (DVA < 0 && DVB > 0 && DVC < 0 && DVD < 0)
            {
                print("point of origin is inside the boundury of 0, A, D, C");
            }
            if (DVA > 0 && DVB < 0 && DVC < 0 && DVD < 0)
            {
                print("point of origin is inside the boundury of 0, D, B, C");
            }

            if (DVA < 0 && DVB < 0 && DVC < 0 && DVD < 0)
            {
                print("point of origin is inside the boundury of all points");
            }
        ...
        else
        {
            ...
            if (DVA < 0 && DVB < 0 && DVC > 0 && DVD > 0)
            {
                print("point of origin is inside the boundury of 0, C, and D");
            }
            if (DVA < 0 && DVB > 0 && DVC < 0 && DVD > 0)
            {
                print("point of origin is inside the boundury of 0, B and D");
            }

            if (DVA < 0 && DVB > 0 && DVC > 0 && DVD < 0)
            {
                print("point of origin is inside the boundury of 0, C,B");
            }

            if (DVA > 0 && DVB < 0 && DVC > 0 && DVD < 0)
            {
                print("point of origin is inside the boundury of 0, A,C");
            }
            if (DVA > 0 && DVB < 0 && DVC < 0 && DVD > 0)
            {
                print("point of origin is inside the boundury of 0, A,D");
            ...
            if (DVA > 0 && DVB > 0 && DVC < 0 && DVD < 0)
            {
                print("point of origin is inside the boundury of 0, A,B");
            }
